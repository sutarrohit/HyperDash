...
export const news = createRoute({
    ...
    responses: {
        [HttpStatusCodes.OK]: jsonContent(NewsListResponseSchema, "Paginated news articles")
    }
});
...
export const newsDetail = createRoute({
    ...
    responses: {
        ...
        [HttpStatusCodes.NOT_FOUND]: jsonContent(NewsArticleSchema.nullable(), "Not found")
    }
});
...
export const companyNews = createRoute({
    ...
    responses: {
        [HttpStatusCodes.OK]: jsonContent(NewsArticleSchema.array(), "Company news")
    }
});
